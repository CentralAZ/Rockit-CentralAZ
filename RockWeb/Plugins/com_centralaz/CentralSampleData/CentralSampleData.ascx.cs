...
namespace RockWeb.Blocks.Examples
{
    ...
    /// </summary>
    [DisplayName( "Central Sample Data" )]
    [Category( "com_centralaz > Central Examples" )]
    ...
    public partial class CentralSampleData : Rock.Web.UI.RockBlock
    {
        #region Fields
...
<p>Here are some of the things you'll find in the sample data:</p>{1}",
        ...
        /// <summary>
        /// Records the current date into the CentralSampleData system setting
        ...
        /// <summary>
        /// Handles the BlockUpdated event of the CentralSampleData control.
        /// </summary>
